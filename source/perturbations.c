    ...
    for (index_k=0; index_k<ppt->k_size[index_md]; index_k++) {
      ...
      if (output_format == class_format) {
        ...
        if (ppt->has_density_transfers == _TRUE_) {
          ...
          class_store_double(dataptr,tk[ppt->index_tp_delta_dmde],ppt->has_source_delta_dmde,storeidx);
          ...
          class_store_double(dataptr,tk[ppt->index_tp_phi_scf],ppt->has_source_delta_scf,storeidx); // TLS
        ...
        if (ppt->has_velocity_transfers == _TRUE_) {
          ...
          class_store_double(dataptr,tk[ppt->index_tp_theta_dmde],ppt->has_source_theta_dmde,storeidx);
        ...
        class_store_double_or_default(dataptr,-tk[ppt->index_tp_delta_dmde]/k2,ppt->has_source_delta_dmde,storeidx,0.0);
...
int perturb_output_titles(
  ...
  if (output_format == class_format) {
    ...
    if (ppt->has_density_transfers == _TRUE_) {
      ...
      class_store_columntitle(titles,"d_dmde",pba->has_dmde);
...
int perturb_indices(
  ...
  ppt->has_source_delta_dmde = _FALSE_;
  ...
  ppt->has_source_theta_dmde = _FALSE_;
  ...
  for (index_md = 0; index_md < ppt->md_size; index_md++) {
    ...
    if (_scalars_) {
      ...
      if (ppt->has_density_transfers == _TRUE_) {
        ...
        if (pba->has_dmde == _TRUE_)
            ppt->has_source_delta_dmde = _TRUE_;
        if (pba->has_dcdm == _TRUE_)
      ...
      if (ppt->has_velocity_transfers == _TRUE_) {
        ...
        if ((pba->has_dmde == _TRUE_))
            ppt->has_source_theta_dmde = _TRUE_;
        if (pba->has_dcdm == _TRUE_)
      ...
      class_define_index(ppt->index_tp_delta_dmde, ppt->has_source_delta_dmde,index_type,1);
      ...
      class_define_index(ppt->index_tp_phi_scf,  ppt->has_source_delta_scf, index_type,1);
...
int perturb_prepare_k_output(struct background * pba,
  ...
  if (ppt->k_output_values_num > 0) {
    ...
    if (ppt->has_scalars == _TRUE_){
      ...
      class_store_columntitle(ppt->scalar_titles,"delta_dmde",pba->has_dmde);
      class_store_columntitle(ppt->scalar_titles,"theta_dmde",pba->has_dmde);
      ...
      class_store_columntitle(ppt->scalar_titles, "phi_scf", pba->has_scf);
      /** Fluid */
...
int perturb_vector_init(
  ...
  if (_scalars_) {
    ...
    class_define_index(ppv->index_pt_delta_dmde,pba->has_dmde,index_pt,1); /* cdm density */
    class_define_index(ppv->index_pt_theta_dmde,pba->has_dmde,index_pt,1); /* cdm velocity */
  ...
  /** - case of switching approximation while a wavenumber is being integrated */
    ...
    if (_scalars_) {
      ...
      if (pba->has_dmde == _TRUE_) {
        ...
        ppv->y[ppv->index_pt_delta_dmde] =
          ppw->pv->y[ppw->pv->index_pt_delta_dmde];

          ppv->y[ppv->index_pt_theta_dmde] =
            ppw->pv->y[ppw->pv->index_pt_theta_dmde];
      }
...
int perturb_initial_conditions(struct precision * ppr,
  ...
  double delta_ur=0.,theta_ur=0.,shear_ur=0.,l3_ur=0.,eta=0.,delta_cdm=0.,delta_dmde=0.,alpha, alpha_prime;
  double delta_dr=0;
  double q,epsilon,k2;
  ...
  if (_scalars_) {
    ...
    */
    ...
    if ((ppt->has_ad == _TRUE_) && (index_ic == ppt->index_ic_ad)) {
      ...
      if (pba->has_dmde == _TRUE_) {
        ppw->pv->y[ppw->pv->index_pt_delta_dmde] = 3./4.*ppw->pv->y[ppw->pv->index_pt_delta_g]; /* dmde density */
        ppw->pv->y[ppw->pv->index_pt_theta_dmde] = 0.0; /* cdm density */
        /* cdm velocity vanishes in the synchronous gauge */
      }
  ...
  if (_scalars_) {
    ...
    if (ppt->gauge == synchronous) {
      ...
      ppw->pvecmetric[ppw->index_mt_h_prime] =
        (k2 * s2_squared * y[ppw->pv->index_pt_eta] + 1.5 * a2 * ppw->delta_rho)/(0.5*a_prime_over_a);  /* h' TLS */
...
int perturb_total_stress_energy(
  ...
  if (_scalars_) {
    ...
    /* cdm contribution */
    if (pba->has_cdm == _TRUE_) {
      ppw->delta_rho += (1.-pba->frac_dmde)*ppw->pvecback[pba->index_bg_rho_cdm]*y[ppw->pv->index_pt_delta_cdm]; // contribution to total perturbed stress-energy
      ppw->rho_plus_p_tot += (1.-pba->frac_dmde)*ppw->pvecback[pba->index_bg_rho_cdm];
      if (ppt->gauge == newtonian)
      ...
      if (ppt->has_source_delta_m == _TRUE_) {
        delta_rho_m += (1.-pba->frac_dmde)*ppw->pvecback[pba->index_bg_rho_cdm]*y[ppw->pv->index_pt_delta_cdm]; // contribution to delta rho_matter
        rho_m += (1.-pba->frac_dmde)*ppw->pvecback[pba->index_bg_rho_cdm];
      }
      if ((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_)) {
        if (ppt->gauge == newtonian)
          rho_plus_p_theta_m += (1.-pba->frac_dmde)*ppw->pvecback[pba->index_bg_rho_cdm]*y[ppw->pv->index_pt_theta_cdm]; // contribution to [(rho+p)theta]_matter
        rho_plus_p_m += (1.-pba->frac_dmde)*ppw->pvecback[pba->index_bg_rho_cdm];
      }
    }
    ...
    if (pba->has_dmde == _TRUE_) {
      ...
      ppw->delta_rho += pba->frac_dmde*ppw->pvecback[pba->index_bg_f_scf]*ppw->pvecback[pba->index_bg_rho_cdm]*y[ppw->pv->index_pt_delta_dmde]; // contribution to total perturbed stress-energy
      ppw->rho_plus_p_tot += pba->frac_dmde*ppw->pvecback[pba->index_bg_f_scf]*ppw->pvecback[pba->index_bg_rho_cdm];
       ppw->rho_plus_p_theta +=  pba->frac_dmde*ppw->pvecback[pba->index_bg_f_scf]*ppw->pvecback[pba->index_bg_rho_cdm]*y[ppw->pv->index_pt_theta_dmde];

      if ((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_)){
        delta_rho_m += pba->frac_dmde*ppw->pvecback[pba->index_bg_f_scf]*ppw->pvecback[pba->index_bg_rho_cdm]*y[ppw->pv->index_pt_delta_dmde]; // contribution to delta rho_matter
        rho_m += pba->frac_dmde*ppw->pvecback[pba->index_bg_f_scf]*ppw->pvecback[pba->index_bg_rho_cdm];
        rho_plus_p_theta_m += pba->frac_dmde*ppw->pvecback[pba->index_bg_f_scf]*ppw->pvecback[pba->index_bg_rho_cdm]*y[ppw->pv->index_pt_theta_dmde]; // contribution to [(rho+p)theta]_matter
        rho_plus_p_m += pba->frac_dmde*ppw->pvecback[pba->index_bg_f_scf]*ppw->pvecback[pba->index_bg_rho_cdm];
        }
      }
    ...
    /* scalar field contribution.
       ...
       species with non-zero shear. TLS
    */
    if (pba->has_scf == _TRUE_) {
      ...
      if (ppt->gauge == synchronous){
        ...
        //    + (ppw->pvecback[pba->index_bg_df_scf]+ppw->pvecback[pba->index_bg_dV_scf])*y[ppw->pv->index_pt_phi_scf]);
        delta_rho_scf =  1./3.*
          (1./a2*ppw->pvecback[pba->index_bg_phi_prime_scf]*y[ppw->pv->index_pt_phi_prime_scf]
           + (3.*pba->frac_dmde*ppw->pvecback[pba->index_bg_rho_cdm]*ppw->pvecback[pba->index_bg_df_scf]+ppw->pvecback[pba->index_bg_dV_scf])*y[ppw->pv->index_pt_phi_scf]);
        delta_p_scf = 1./3.*
          (1./a2*ppw->pvecback[pba->index_bg_phi_prime_scf]*y[ppw->pv->index_pt_phi_prime_scf]
...
int perturb_sources(
  ...
  if (_scalars_) {
    ...
    if (ppt->has_source_delta_dmde == _TRUE_) {
      _set_source_(ppt->index_tp_delta_dmde) = y[ppw->pv->index_pt_delta_dmde]
        + 3.*a_prime_over_a*theta_over_k2; // N-body gauge correction
    }
    ...
    if (ppt->has_source_theta_dmde == _TRUE_) {
      _set_source_(ppt->index_tp_theta_dmde) = y[ppw->pv->index_pt_theta_dmde];
        //+ theta_shift; // N-body gauge correction
    }
...
int perturb_print_variables(double tau,
  ...
  double delta_dmde=0.,theta_dmde=0.;
  ...
  double delta_scf=0., phi_scf=0., theta_scf=0.;
  ...
  if (_scalars_) {
    ...
    if (pba->has_dmde == _TRUE_) {
      delta_dmde = y[ppw->pv->index_pt_delta_dmde];
      theta_dmde = y[ppw->pv->index_pt_theta_dmde];
    }
    ...
    if (pba->has_scf == _TRUE_){
      ...
      phi_scf = y[ppw->pv->index_pt_phi_scf];// TLS
    ...
    /* converting synchronous variables to newtonian ones */
     if (ppt->gauge == synchronous) {
       ...
       if (pba->has_dmde == _TRUE_) {
         delta_dmde -= 3. * pvecback[pba->index_bg_H]*pvecback[pba->index_bg_a]*alpha;
         theta_dmde += k*k*alpha;
       }
    ...
    /* dmde */
    class_store_double(dataptr, delta_dmde, pba->has_dmde, storeidx);
    class_store_double(dataptr, theta_dmde, pba->has_dmde, storeidx);
    ...
    class_store_double(dataptr, phi_scf, pba->has_scf, storeidx);
    /** Fluid */
...
int perturb_derivs(double tau,
  ...
  if (_scalars_) {
    ...
    /** - ----> synchronous gauge: dmde density and velocity */

    if (ppt->gauge == synchronous) {
      dy[pv->index_pt_delta_dmde] = -(y[pv->index_pt_theta_dmde]+metric_continuity); /* dmde density */

      dy[pv->index_pt_theta_dmde] = -a_prime_over_a*y[pv->index_pt_theta_dmde]
      + pvecback[pba->index_bg_df_scf]/pvecback[pba->index_bg_f_scf]
      * (k2*y[pv->index_pt_phi_scf]-y[pv->index_pt_theta_dmde]*pvecback[pba->index_bg_phi_prime_scf]);

      //dy[pv->index_pt_theta_dmde] = 0.0;

      // (-(a_prime_over_a*pvecback[pba->index_bg_f_scf]
      // +pvecback[pba->index_bg_df_scf]*pvecback[pba->index_bg_phi_prime_scf])*y[pv->index_pt_theta_dmde]
      // +k2*pvecback[pba->index_bg_df_scf]*y[pv->index_pt_phi_scf])/pvecback[pba->index_bg_f_scf]; /* dmde velocity */
    }
    ...
    if (pba->has_scf == _TRUE_) {
      ...
      dy[pv->index_pt_phi_prime_scf] =  - 2.*a_prime_over_a*y[pv->index_pt_phi_prime_scf]
        - metric_continuity*pvecback[pba->index_bg_phi_prime_scf] //  metric_continuity = h'/2
        - (k2 + a2*pvecback[pba->index_bg_ddV_scf]+a2*3.*pba->frac_dmde*pvecback[pba->index_bg_rho_cdm]*pvecback[pba->index_bg_ddf_scf])
        *y[pv->index_pt_phi_scf]
        -a2*pvecback[pba->index_bg_df_scf]*pba->frac_dmde*3.*pvecback[pba->index_bg_rho_cdm]*y[pv->index_pt_delta_dmde]; //NOT checked ;-)
