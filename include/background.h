...
struct background
{
  ...
  double frac_dmde; /**< \f$ fraction of the DM which interacts with the scalar field */
  double g_scf; /**< \f$ dimensionless non-minimal coupling strength */
  double m_scf; /**< \f$ mass of the non-minimal scalar field */
  double phi_scf_ini; /**< \f$ initial value of the non-minimal scalar field */
  double f_ede,log10_z_c,phi_scf_c;
  ...
  int index_bg_f_scf;         /**< scalar field coupling potential f */
  int index_bg_df_scf;        /**< scalar field coupling potential deriv f' */
  int index_bg_ddf_scf;       /**< scalar field coupling potential second derivative f'' */
  ...
  short has_dmde;      /**< presence of a non-minimally coupled scalar field */
