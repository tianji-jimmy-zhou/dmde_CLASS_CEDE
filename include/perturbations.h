...
struct perturbs
{
  ...
  short has_source_delta_dmde;  /**< do we need source for delta of dmde */
  ...
  short has_source_theta_dmde;   /**< do we need source for theta of cold dark matter? */
  ...
  int index_tp_delta_dmde;/**< index value for delta of dmde */
  ...
  int index_tp_theta_dmde;   /**< index value for theta of cold dark matter */
  ...
  int index_tp_phi_scf;      /**< index value for field perturbation */
...
struct perturb_vector
{
  ...
  int index_pt_delta_dmde; /**< dcdm density */
  int index_pt_theta_dmde; /**< dcdm velocity */
